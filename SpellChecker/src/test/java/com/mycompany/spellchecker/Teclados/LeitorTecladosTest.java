...
//QUERTY
        ...
        assertEquals(expResult.get(0).getOffset3(), result.get(0).getOffset3(), 0.1);
...
//QWERTZ
        ...
        assertEquals(expResult.get(1).getOffset3(), result.get(1).getOffset3(), 0.1);
...
//AZERTY
        ...
        assertEquals(expResult.get(2).getOffset3(), result.get(2).getOffset3(), 0.1);
...
//DVORAK
        ...
        assertEquals(expResult.get(3).getOffset3(), result.get(3).getOffset3(), 0.1);
//COLEMAN
        ...
        assertEquals(expResult.get(4).getOffset3(), result.get(4).getOffset3(), 0.1);
...
//WORKMAN
        ...
        assertEquals(expResult.get(5).getOffset3(), result.get(5).getOffset3(), 0.1);
